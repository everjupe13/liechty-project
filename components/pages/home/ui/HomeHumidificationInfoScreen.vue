<template>
  <section
    class="border-b border-dark/20 pb-60 pt-[140px] xl:py-80 lg:py-60 md:py-40"
  >
    <div class="container">
      <div
      ...
      >
        ...
        <div>
          <ul class="unordered-list text-18">
            ...
            <li>Protects furniture and interior made of wood</li>
          </ul>
        </div>
        <div>
          <p class="mb-40 leading-snug text-18">
            ...
            <br />
            <br />
            Many scientific researches confirm that optimum indoor humidity
            level is 40 - 60% RH.
            <br />
            <br />
            Ideal humidity range improves our health & wellbeing, prevent
            spreading of flu, protects wood interiors.
          </p>
        </div>
      </div>
    </div>
